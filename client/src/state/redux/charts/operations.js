...
const blockPerHour = channelName => dispatch =>
	get(`/apiLedger/blocksByHour/${channelName}/1`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
...
const blockPerMin = channelName => dispatch =>
	get(`/apiLedger/blocksByMinute/${channelName}/1`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
...
const changeChannel = channelName => dispatch =>
	get(`/apiLedger/changeChannel/${channelName}`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
...
const dashStats = channelName => dispatch =>
	get(`/apiLedger/status/${channelName}`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
...
const blockActivity = channelName => dispatch =>
	get(`/apiLedger/blockActivity/${channelName}`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
...
const peerStatus = channelName => dispatch =>
	get(`/apiLedger/peersStatus/${channelName}`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
...
const transactionByOrg = channelName => dispatch =>
	get(`/apiLedger/txByOrg/${channelName}`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
...
const transactionPerHour = channelName => dispatch =>
	get(`/apiLedger/txByHour/${channelName}/1`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
...
const transactionPerMin = channelName => dispatch =>
	get(`/apiLedger/txByMinute/${channelName}/1`)
		.then(resp => {
			if (resp.status === 500) {
				dispatch(
					actions.getErroMessage(
