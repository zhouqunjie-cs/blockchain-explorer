...
export async function adminroutes(router, platform) {
	...
	/*
	 * Register
	 * curl 'http://<host>:<port>/apiLedger/register'  -H 'Accept: application/json'
	...
	/*
	 * Userlist
	 * curl 'http://<host>:<port>/apiLedger/userlist' -H 'Accept: application/json' \
	 * -H 'Authorization: bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.8iTytz6wkPMVJzgD3jIGTQ2s2UZLO8nzvJQJGR0rs_0'
	 *
	 */
	...
	/*
	 * UnRegister
	 * curl 'http://<host>:<port>/apiLedger/unregister' -H 'Accept: application/json
	 * -H 'Authorization: bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.8iTytz6wkPMVJzgD3jIGTQ2s2UZLO8nzvJQJGR0rs_0'
	 * -H 'Content-Type: application/json'
